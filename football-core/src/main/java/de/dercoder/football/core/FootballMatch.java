...
public final class FootballMatch {
  ...
  public Optional<FootballTeam[]> teams() {
    return Optional.ofNullable(teams.clone());
  }
  ...
  public static FootballMatch empty(Football football, FootballGoal[] goals) {
    Preconditions.checkNotNull(football);
    Preconditions.checkNotNull(goals);
    return new FootballMatch(football, goals, null, Sets.newHashSet());
  }
}
