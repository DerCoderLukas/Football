...
final class FootballMatchTest {
    ...
    void initialize() {
        ...
        footballMatch = FootballMatch.of(
                football,
                goals,
                teams,
                playerSessions
    ...
    void teamPlayersToSessionSet(
            ...
            Set<FootballPlayerSession> playerSessions
    ) {
        footballTeam.players().stream()
                .map(this::sessionFromPlayer).forEach(playerSessions::add);
    }

    FootballPlayerSession sessionFromPlayer(FootballPlayer footballPlayer) {
        return FootballPlayerSession.of(
                footballPlayer,
                0,
