...
public final class FootballStadiumModel {
    ...
    FootballStadiumModel(
            String name,
            FootballLocationModel stadiumCenter,
    ...
    public FootballStadium toFootballStadium() {
        ...
        return FootballStadium.of(
                name,
                stadiumCenter.toLocation(),
                stadiumGoals
        );
    }
    ...
    public static FootballStadiumModel ofFootballStadium(
            FootballStadium footballStadium
    ) {
        Preconditions.checkNotNull(footballStadium);
        var stadiumCenterModel = FootballLocationModel
                .ofLocation(footballStadium.stadiumCenter());
