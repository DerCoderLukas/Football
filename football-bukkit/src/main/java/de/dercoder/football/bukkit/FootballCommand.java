...
public final class FootballCommand implements CommandExecutor {
  ...
  private boolean onFootballOverview(CommandSender commandSender, Command command) {
  ...
  private boolean onFootballStadiumList(CommandSender commandSender, Command command) {
  ...
  private boolean onFootballStadiumCreate(
    ...
    if (arguments.length == 3) {
      ...
      footballStadiumRepository
          .find(footballStadiumName)
          .ifPresentOrElse(
              footballStadium -> {
              ...
              () -> {
                ...
                var footballStadium =
                    FootballStadium.of(footballStadiumName, playerLocation, footballGoals);
  ...
  private boolean onFootballStadiumGoal(
    ...
    if (arguments.length == 6) {
        ...
        footballStadiumRepository
            ...
            .ifPresentOrElse(
                footballStadium -> {
                  try {
                    var direction =
                        DefaultFootballGoal.FootballGoalDirection.valueOf(
                            directionString.toUpperCase());
                    var player = (Player) commandSender;
                    var playerLocation = player.getLocation();
                    var footballGoal =
                        DefaultFootballGoal.of(playerLocation, width, height, direction);
                    footballStadium.addFootballGoal(footballGoal);
                    sendPrefixMessage(
                        commandSender, "You successfully added a new goal to the stadium.");
                  } catch (Exception exception) {
                    sendPrefixMessage(
                        commandSender, "Can't find the direction " + directionString + ".");
                  }
                },
                () -> {
      ...
      sendSyntaxCorrection(
          commandSender, "/football stadium goal <stadium name> <width> <height> <direction>");
      return false;
    }
    return true;
  }
      ...
      footballStadiumRepository
          ...
          .ifPresentOrElse(
              footballStadium -> {
                ...
                sendPrefixMessage(
                    commandSender, "      - X: " + footballStadiumCenterLocation.getX());
                sendPrefixMessage(
                    commandSender, "      - Y: " + footballStadiumCenterLocation.getY());
                sendPrefixMessage(
                    commandSender, "      - Z: " + footballStadiumCenterLocation.getZ());
                sendPrefixMessage(
                    commandSender, "  - Goals: " + footballStadium.footballGoals().length);
              },
              () -> {
                sendPrefixMessage(commandSender, "Can't find any stadium with that name.");
              });
  ...
  private boolean onFootballStadiumOverview(CommandSender commandSender, Command command) {
    sendPrefixMessage(commandSender, "Football-Stadium:");
    sendPrefixMessage(commandSender, "  - /football stadium list");
  ...
  private boolean onFootballGame(CommandSender commandSender, Command command, String[] arguments) {
    if (arguments.length > 1) {
      var keyword = arguments[1];
      if (keyword.equalsIgnoreCase("list")) {
  ...
  private boolean onFootballGameList(CommandSender commandSender, Command command) {
  ...
  private boolean onFootballGameCreate(
    ...
    if (arguments.length == 5) {
          ...
          .ifPresentOrElse(
              footballStadium -> {
                if (footballGameRegistry.findGameByStadium(footballStadium).isEmpty()) {
                  ...
                  var football =
                      defaultFootballFactory.createDefaultFootball(footballStadium.stadiumCenter());
                  ...
                  footballGameFactory.createFootballGame(footballMatch, footballStadium);
                  sendPrefixMessage(
                      commandSender,
                      "You successfully created a new football game at "
                          + "the stadium "
                          + footballStadiumName
                          + ".");
                } else {
                  sendPrefixMessage(
                      commandSender, "There is already a football game running to that stadium.");
                }
              },
              () -> {
                sendPrefixMessage(commandSender, "Can't find any stadium with that name.");
      ...
      sendSyntaxCorrection(
          commandSender,
          "/football game create <stadium> <players of the first team> "
          ...
          .ifPresentOrElse(
              footballStadium -> {
                footballGameRegistry
                    .findGameByStadium(footballStadium)
                    .ifPresentOrElse(
                        footballGame -> {
                          sendPrefixMessage(
                              commandSender, "Football-Game-" + footballStadiumName + ":");
                          ...
                          displayFootballTeam(
                              commandSender, footballGame, footballTeams[0], "First");
                          displayFootballTeam(
                              commandSender, footballGame, footballTeams[1], "Second");
                        },
                        () -> {
                          sendPrefixMessage(
                              commandSender, "Can't find any football game at that stadium.");
                        });
              },
              () -> {
                sendPrefixMessage(commandSender, "Can't find any stadium with that name.");
  ...
  private void displayFootballTeam(
    ...
    var players = footballGame
            .findTeamPlayers(footballTeam)
                ...
                footballGameRegistry
                    ...
                    .ifPresentOrElse(
                        footballGame -> {
                          footballGame.close();
                          sendPrefixMessage(
                              commandSender, "You successful stopped the football game.");
                        },
                        () -> {
                          sendPrefixMessage(
                              commandSender, "Can't find any football game at that stadium.");
  ...
  private boolean onFootballGameOverview(CommandSender commandSender, Command command) {
    sendPrefixMessage(commandSender, "Football-Game:");
    sendPrefixMessage(commandSender, "  - /football game list");
    sendPrefixMessage(
        commandSender,
  ...
  private void sendSyntaxCorrection(CommandSender commandSender, String correction) {
